...
$(document).ready(function () {
    ...
    const dataTable = $('#bannerTable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "https://api.ontario.edu.kh/bannerSlideread.php?action=read", // API endpoint for reading data
            "type": "GET"
        },
        "columns": [
            {
    ...
    $('#bannerForm').on('submit', function (e) {
        ...
        $.ajax({
            url: `https://api.ontario.edu.kh/bannerSlideread.php?action=${action}`,
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    $(document).on('click', '.edit-btn', function () {
        ...
        $.ajax({
            url: `https://api.ontario.edu.kh/bannerSlideread.php?action=read&id=${id}`,
            type: 'GET',
    ...
    $(document).on('click', '.delete-btn', function () {
        ...
        if (confirm('Are you sure you want to delete this banner?')) {
            $.ajax({
                url: `https://api.ontario.edu.kh/bannerSlideread.php?action=delete&id=${id}`,
                type: 'POST',
                success: function (result) {
                    var table = $('#bannerTable').DataTable();
                    table.ajax.reload(); // Reload the data table
...
function Aprove(id,title) {
    ...
    alert(titleAs)
    $.ajax({
    url: `https://api.ontario.edu.kh/bannerSlideread.php?action=update&id=${id}`, // This is your server-side script
    type: 'POST',
